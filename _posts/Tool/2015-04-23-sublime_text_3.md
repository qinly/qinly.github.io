...
一个强大的文件模板插件：[FileHeader](https://github.com/shiyanhui/FileHeader)

![alt text][id]

[id]: ../../assets/img/sublime/001xx.gif "强大的文件模板插件"

--- 分割线

# Sublime

收集一些 Sublime package，文本包，主题，教程，文章和好东西

## 开始

- [Sublime Text](http://www.sublimetext.com/) - 如果你还没有安装的文本编辑器
- [非官方文档](http://docs.sublimetext.info/en/latest/index.html) (翻墙访问)
- [Package Control](https://sublime.wbond.net/installation) - 不可或缺的软件包管理器
